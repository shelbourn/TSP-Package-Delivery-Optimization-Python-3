...
"""
        ...
        print(main_menu)
        # total_mileage = get_total_mileage()
        # total_transit_time = get_total_transit_time()
        # truck_1_mileage = get_total_mileage_truck_1()
        # truck_2_mileage = get_total_mileage_truck_2()
        # truck_3_mileage = get_total_mileage_truck_3()
        # truck_1_transit_time = get_total_transit_time_truck_1()
        # truck_2_transit_time = get_total_transit_time_truck_2()
        # truck_3_transit_time = get_total_transit_time_truck_3()
